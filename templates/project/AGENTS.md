...
This file tells Codex how to work in this repository. Keep project-specific rules below the universal Codex Gospel block.
...
Replace this section with local truth:
...
- Verification floor:
  - State what must run before completion is claimed.
